...
const PARTICLE_PRESETS = {
  ...
  fire: {
    count: 6,
    colors: [0xffff00, 0xff8800, 0xff4400, 0xff0000],
    size: { min: 0.05, max: 0.14 },
    speed: { min: 2, max: 4 },
    gravity: -8,
    lifetime: 0.4,
    spread: 0.6,
